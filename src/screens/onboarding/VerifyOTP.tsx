  ...
  return (
    <View style={[localStyles.wrapper, {width}]}>
      ...
      <View style={localStyles.container}>
        <View>
          <Text style={localStyles.title}>Enter Verification Code</Text>
          ...
          <Text style={localStyles.termsAndConditionsText}>
            OTP will expire in <Countdown time={120} ref={countdownRef} />
          </Text>
          <Pressable
        ...
        <StyledButton
          ...
          onPress={() => {
            if (isOTPReady) props.navigation.navigate('NewPassword');
          }}
        />
      </View>
    </View>
