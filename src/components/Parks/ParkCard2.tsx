...
export default function ParkCard2(props: any) {
  return (
    <Pressable
      style={[
        {
      ...
      <View
        ...
        <View
          ...
          <View
            ...
            <FontAwesome name="rupee" size={24} color={colors.darkGrey} />
            <Text
              style={[styles.bold, {color: colors.darkGrey, marginLeft: 5}]}>
              {props.price}
            </Text>
          </View>
          <Text style={[styles.regular, {color: colors.grey, marginLeft: 20}]}>
            {props.availability}
          </Text>
        </View>
      </View>
